...
export const mockSimulationHighChaos: Simulation = {
  ...
  relicImage: '/images/incidents/cuban-crisis.jpg',
  storyCards: [
    {
      id: 'cuba-story-1',
      year: '1962',
      title: 'The Torpedo Launch',
      description:
        'A Soviet submarine captain fires a nuclear torpedo at the USS Beale. The Caribbean sea erupts in light visible from Havana.',
      imagePrompt: 'Cold War submarine nuclear explosion at sea, archival photograph style',
      image: '/images/incidents/cuban-crisis.jpg',
      isAlternate: true,
    },
    {
      id: 'cuba-story-2',
      year: '1962',
      title: 'Retaliation Chain',
      description:
        'American naval forces respond within hours. Missile sites across Cuba are targeted as both superpowers cross the nuclear threshold.',
      imagePrompt: '1960s military crisis war room, tense officials, vintage photo',
      image: '/images/timelines/cold-war.jpg',
      isAlternate: true,
    },
    {
      id: 'cuba-story-3',
      ...
      description:
        'Survivors place memorial plaques among the ruins of once-great cities. A new world order begins in the southern hemisphere.',
      imagePrompt: 'Post-apocalyptic memorial ruins, overgrown monument, grainy photo',
      image: '/images/story/missed-shot.jpg',
      isAlternate: true,
    },
  ],
...
/** Story slides for the immersive gallery (fallback from ripples if needed). */
